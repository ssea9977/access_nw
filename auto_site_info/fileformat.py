...
form = resource_path('siteinfo.ui')
...
class WindowClass(QMainWindow, form_main):
    ...
    def fileformat(self):
        ...
        driver.find_element_by_xpath('//*[@id="root"]/nav/div/ul[2]/li/a').click()
        driver.find_element_by_xpath('//*[@id="root"]/nav/div/ul[2]/li/ul/li[11]/a').click()

        # 5G_OFFLOADING download
        driver.find_element_by_xpath('//*[@id="root"]/nav/div/ul[2]/li/a').click()
        driver.find_element_by_xpath('//*[@id="root"]/nav/div/ul[2]/li/ul/li[16]/a').click()
