...
ZABBIX_API_URL = "http://172.21.27.206/api_jsonrpc.php"
UNAME = "Admin"
PWORD = "zabbix"
...
print(host)
host.to_csv('host_check.csv')

db_connection_str = 'mysql+pymysql://root:Rkdqnrlte1q@172.21.27.209/oneview'
db_connection = create_engine(db_connection_str)
conn = db_connection.connect()
host.to_sql(name='zabbix_host_info_5g', con=db_connection, if_exists='replace',index=False)  